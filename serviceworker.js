    ...
    .then((obj) => {
      ...
      caches.open('todo-pwa-v1').then((cache) => {
        return cache.addAll([
          ...
          `/todo-pwa/assets/js/dist/25.${hash}.js`,
          `/todo-pwa/assets/js/dist/29.${hash}.js`,
          `/todo-pwa/assets/js/dist/58.${hash}.js`,
          `/todo-pwa/assets/js/dist/189.${hash}.js`,
          `/todo-pwa/assets/js/dist/314.${hash}.js`,
          `/todo-pwa/assets/js/dist/579.${hash}.js`,
          `/todo-pwa/assets/js/dist/636.${hash}.js`,
          `/todo-pwa/assets/js/dist/671.${hash}.js`,
          `/todo-pwa/assets/js/dist/676.${hash}.js`,
          `/todo-pwa/assets/js/dist/839.${hash}.js`,
          `/todo-pwa/assets/js/dist/909.${hash}.js`,
        ]);
      });
    })
    .catch((err) => {
